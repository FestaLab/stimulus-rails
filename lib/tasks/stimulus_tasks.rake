...
namespace :stimulus do
  ...
  namespace :manifest do
    ...
    task :update, [:path] do |_, args|
      path = args[:path] || "app/javascript/controllers"

      manifest =
        Stimulus::Manifest.generate_from(Rails.root.join(path))

      File.open(Rails.root.join(path, "index.js"), "w+") do |index|
