...
namespace :stimulus do
  ...
  namespace :manifest do
    ...
    task :update do
      Rails.root.join("app/assets/javascript/controllers").children.select(&:directory?).each do |entrypoint|
        manifest = Stimulus::Manifest.generate_from(entrypoint)

        File.open(entrypoint.join("index.js"), "w+") do |index|
